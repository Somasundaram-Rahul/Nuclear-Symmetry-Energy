...
def T_SM_eff_2 (x):
    return T_SM(x)*m_e_inv_SM_2(x)

def T_NM_eff_2 (x):
    return T_NM(x)*m_e_inv_NM_2(x)
...
### Plot with additional data (Ingo, Aurel, APR)
...
### Plot with additional data, Scaling 1 (Ingo, Aurel, APR)
